<div>
    <button class="" style="background-color: rgba(4, 176, 0, 0.2); padding:2rem; width:12rem; height:12rem; border-radius:2rem;">
        ...
        <span><p style="color: #04B000; font-weight: bold; font-size: 1.4rem;" class="">@yield('button-text')</p></span>
    </button>>
</div>
